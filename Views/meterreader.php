...
<div class="container mt-4 Options">
    <div class="row">
        <div class="col-md-6">
            <a href="updatemeter.php">
                <div class="content">
                    <img src="../images/update.avif" alt="fun1">
			              <h2>UPDATE METER READING</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="warningmeter.php">
                <div class="content">
                    <img src="../images/sendnotification.png" alt="fun1">
        ...
        <div class="col-md-6">
            <a href="profilemanage.php">
                <div class="content">
                    <img src="../images/profile.png" alt="fun1">
			              <h2>MANAGE PROFILE </h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="viewmeter.php">
                <div class="content">
                    <img src="../images/generatereports.jpg" alt="fun1">
			              <h2>VIEW METER DETAILS</h2>
                </div>
            </a>
        </div>
    </div>
